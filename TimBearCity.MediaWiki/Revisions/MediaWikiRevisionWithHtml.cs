...
/// <summary>A revision, including its rendered HTML.</summary>
...
/// <param name="Html">The revision content rendered as HTML.</param>
public sealed record MediaWikiRevisionWithHtml(
    long Id,
    int Size,
    bool IsMinor,
